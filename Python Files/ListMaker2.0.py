...
`
    ...
    def exportLists(self, outputFilename = "Lists.xlsx"):
        ...
        worksheet.write("B1", "Chapter", bold)
        worksheet.write("C1", "Verse", bold)
        worksheet.write("D1", "Question Type", bold)
        worksheet.write("E1", "Question", bold)
        ...
        for verse in self.allVerses:
            ...
            worksheet.write("B" + str(i), verse[1])
            worksheet.write("C" + str(i), verse[2])
            worksheet.write("D" + str(i), "Q")
            worksheet.write_rich_string("E" + str(i), "Quote " + verse[0] + " chapter " +
                                        verse[1] + " verse " + verse[2] + ".")
            worksheet.write_rich_string("F" + str(i), *self.boldUniqueWords(verse[3], bold))


            #words = verse[3].split(" ")
            #num = len(words)
            #RestOfVerse = ' '.join(words[5:num+1])
            #worksheet.write("G" + str(i), RestOfVerse)
        ...
        ################################################################################################################
        worksheet = workbook.add_worksheet("FTVs With Answer")
        ...
        #i = 2
        #self.allVerses = sorted(self.allVerses, key = itemgetter(3, 1, 2,))
        ...
        #for verse in self.allVerses:
            ...
            #RestOfVerse = [2]
            #RestOfVerse = ' '.join(words[5:num+1])
            #worksheet.write_rich_string("F" + str(i), RestOfVerse)
